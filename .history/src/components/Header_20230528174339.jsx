    ...
    <header className={`bg-white border-b-2 ${isFixed ? 'fixed top-0 z-10 w-full' : ''}`}>
      <div className="container mx-auto flex justify-between items-center py-4 px-5 sm:px-32">
        ...
        <div className="hidden md:flex space-x-8">
          ...
          <link to="#" className="text-gray-800 hover:text-gray-600 text-lg font-semibold">About</a>
          <Link to="#" className="text-gray-800 hover:text-gray-600 text-lg font-semibold">Services</a>
          <Link href="#" className="text-gray-800 hover:text-gray-600 text-lg font-semibold">Contact</a>
        </div>
