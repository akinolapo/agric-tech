...
const data= [
    ...
    },
    {
        ...
        description: 'Molebi AgroTech Hub provides advanced storage and warehousing facilities to ensure the proper handling and preservation of agricultural commodities. We offer storage solutions with temperature control, inventory management systems, and quality control measures, reducing post-harvest losses.',
        // link: '/'
    },
    {
        id: 3,
