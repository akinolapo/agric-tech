      ...
      <div className="container mx-auto py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className='flex items-center text-lg'><AiOutlineMail className='green-icon'/><span>hell0@molebi.com</span></p>
            ...
            <p className='flex items-center text'><AiOutlineTwitter className='green-icon'/><span>Twitter</span></p>
          </div>
        </div>
      </div>
