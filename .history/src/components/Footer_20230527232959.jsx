      ...
      <div className="container mx-auto py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className='flex items-center'><AiOutlineInstagram className='green-'/><span>Instagram</span></p>
            <p className='flex items-center'><AiOutlineInstagram/><span>Instagram</span></p>
            <p className='flex items-center'><AiOutlineInstagram/><span>Instagram</span></p>
            <p className='flex items-center'><AiOutlineInstagram/><span>Instagram</span></p>
            <p className='flex items-center'><AiOutlineInstagram/><span>Instagram</span></p>
          </div>
