      ...
      <div className="container mx-auto py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className='flex items-center'><AiOutlineMail className='green-icon'/><span>Instagram</span></p>
            <p className='flex items-center'><AiOutlinePhone className='green-icon'/><span>+234000000000</span></p>
          </div>
        </div>
      </div>
