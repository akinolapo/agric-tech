...
const ImpactPage = () => {
  ...
  return (
    ...
    <div className="container mx-auto px-5 sm:px-32 py-8">
      <h1 className="text-3xl font-bold mb-4 text-center">Community Impact</h1>
      <hr className='underline-title mb-2 w-32 items-center flex'></hr>
      <hr className='underline-title mt-2 w-20'></hr>
