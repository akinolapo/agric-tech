      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {impactData.map((impact, index) => (
          <div key={index} className="flex">
            <img src={process.env.PUBLIC_URL+ `{impactData.imageSrc}zzzzza`} alt={impact.title} className="w-40 h-40 object-cover rounded-md mr-4" />
            <div>
