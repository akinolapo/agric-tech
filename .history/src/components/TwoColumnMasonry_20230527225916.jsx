    ...
    <div className="container mx-auto py-20 px-5 sm:px-32">
      <div className="grid items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-20">
        <div className="space-y-4 grid grid-cols-2 gap-4 md:space-y-0">
          ...
          <div>
          <img src={process.env.PUBLIC_URL+`media/maize.jpg`} alt="Thumbnail 2" className="w-full rounded-2xl" />
          </div>
          <div>
        ...
        <div>
          <h2 className="text-2xl font-bold text-green-600 mb-4">Innovative Solutions for Agribusiness</h2>
