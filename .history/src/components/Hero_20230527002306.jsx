    ...
    <section className="bg-white text-black py-20 px-5 sm:px-32">
      <div className="container mx-auto flex flex-col lg:flex-row items-center gap-40">
        <div className="lg:w-1/2">
          ...
          <button className="bg-white text-lg bo text-green-500 py-2 px-6 rounded-full font-semibold shadow-xl hover:shadow-2xl transition duration-300">Learn More</button>
        </div>
        <div className="lg:w-1/2">
