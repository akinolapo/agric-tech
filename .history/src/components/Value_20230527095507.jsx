...
const Value = () => {
  return (
    ...
    <div className='text-center'>
        <h2 className='text-2xl text-green-500 font-bold w-2/5'>Our Value Chain</h2>
        <p className='w-2/5'>Our approach is inspired by our determination to improve the agricultural landscape in Africa.</p>
    </div>
