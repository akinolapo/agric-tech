    ...
    <header className={`bg-white border-b-2 ${isFixed ? 'fixed top-0 z-10 w-full' : ''}`}>
      <div className="container mx-auto flex justify-between items-center py-4 px-5 sm:px-32">
        ...
        <div className="hidden md:block">
          <button
            type="button"
            className="bg-white border-green-500 border-2 text-green-500 rounded-lg py-2 px-4 flex items-center hover:bg-green-500 text-white"
          >
            <FiPhoneCall className='green-icon'/> Call Us
          </button>
        </div>
      </div>
      <div>
