        ...
        <h1 className='text-white text-3xl font-bold mb-10'>Our Procedure</h1>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white bg-opacity-80 p-6 md:p-8 rounded-lg shadow-lg">
              ...
              <p className='text-lg'>We understand that adopting new technologies and processes can be challenging. To ensure a smooth transition and maximize the benefits of our innovative solutions, Molebi AgroTech Hub provides comprehensive training and ongoing support.</p>
            </div>
          </div>
        </div>
      </div>
