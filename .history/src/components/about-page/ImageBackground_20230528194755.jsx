      ...
      <div className="relative p-8 md:p-16 lg:p-24">
        ...
        <h1 className='text-black text-3xl font-bold mb-10'>About Us</h1>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white bg-opacity-85 p-6 md:p-8 rounded-lg shadow-lg">
            ...
            <div className="bg-white bg-opacity-80 p-6 md:p-8 rounded-lg shadow-lg">
              ...
              <p>Our mission is to empower farmers and agricultural companies with cutting-edge technology for enhanced productivity and growth.</p>
            </div>
          </div>
        </div>
      </div>
