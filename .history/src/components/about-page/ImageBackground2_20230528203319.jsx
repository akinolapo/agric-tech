        ...
        <h1 className='text-white text-3xl font-bold mb-10'>Our Procedure</h1>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white bg-opacity-80 p-6 md:p-8 rounded-lg shadow-lg">
              ...
              <p className='text-lg'>Based on the insights gathered during the consultation and assessment phase, our skilled professionals at Molebi AgroTech Hub develop customized solutions designed to address your agribusiness needs. We harness cutting-edge technology and industry best practices to create innovative solutions that optimize productivity, streamline processes, and drive growth. Our experienced team will guide you through the implementation process, ensuring a seamless integration of the solutions into your existing operations.</p>
            </div>
