    ...
    <header className="bg-white border-b-4">
      <div className="container mx-auto flex justify-between items-center py-4 px-5 sm:px-32">
        ...
        <div className="md:hidden">
          ...
          {isMenuOpen && (
            <div className="relative bg-white w-full mt-2 py-2 shadow-lg">
              <a href="#" className="block px-4 py-2 text-gray-800 hover:text-gray-600">Home</a>
              <a href="#" className="block px-4 py-2 text-gray-800 hover:text-gray-600">About</a>
              <a href="#" className="block px-4 py-2 text-gray-800 hover:text-gray-600">Services</a>
              <a href="#" className="block px-4 py-2 text-gray-800 hover:text-gray-600">Contact</a>
              <button
                type="button"
                className="block bg-green-500 text-white rounded-lg mt-2 py-2 px-4"
              >
                Food
              </button>
            </div>
