...
const ImageText = () => {
  return (
    <section className="text-black px-5 sm:px-32 py-10">
      <div className="container items-center mx-auto flex flex-col lg:flex-row gap-10 sm:gap-20">
        <div className="lg:w-1/2">
          <h2 className="text-2xl font-bold mb-4 text-green-600">Efficient Processing Techniques</h2>
        ...
        <div className="lg:w-1/2">
          <img src={process.env.PUBLIC_URL+`media/tractor.jpg`}alt="Tractor" className="rounded-lg shadow-xl" />
        </div>
      </div>
    </section>
  );
