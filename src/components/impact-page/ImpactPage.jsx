...
const ImpactPage = () => {
  const impactData = [
    ...
    },
    {
      ...
      imageSrc: process.env.PUBLIC_URL+`media/impact-2.png`,
    },
    {
      ...
      imageSrc: process.env.PUBLIC_URL+`media/impact-3.jpg`,
    },
    {
      ...
      imageSrc: process.env.PUBLIC_URL+`media/impact-4.jpg`,
    },
    {
      ...
      imageSrc: process.env.PUBLIC_URL+`media/impact-5.png`,
    },
    {
      ...
      imageSrc: process.env.PUBLIC_URL+`media/impact-6.jpg`,
    }
  ];
  ...
  return (
    ...
    <div className=" bg-gray-100 mx-auto px-5 sm:px-32 py-8">
      ...
      <p className="text-gray-800 mt-8 mb-8 text-center">
      ...
      <div className="grid grid-cols-1 gap-8 px-5 sm:px-32">
        {impactData.map((impact, index) => (
          <div key={index} className="block sm:flex sm:gap-8 items-center">
            <div>
              <h2 className="text-xl font-semibold mb-2">{impact.title}</h2>
              <p className="text-gray-800 text-lg">{impact.description}</p>
            </div>
